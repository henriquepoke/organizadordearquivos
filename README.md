...
2. Dentro da pasta "pastas", deve conter uma pasta vazia de cada extensão de arquivo para funcionar perfeitamente
3. Adicione os arquivos que vão ser organizados na pasta "organizador"
